...
public class DeviceStateView extends View {
    ...
    public DeviceStateView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DeviceStateView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        //自定义属性
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.DeviceStateBoardView, defStyleAttr, 0);

        mRadius = a.getDimensionPixelSize(R.styleable.DeviceStateBoardView_radius, dpToPx(80));
        mBigSliceCount = a.getInteger(R.styleable.DeviceStateBoardView_bigSliceCount, 5);
        mScaleCountInOneBigScale = a.getInteger(R.styleable.DeviceStateBoardView_sliceCountInOneBigSlice, 5);
        mScaleColor = a.getColor(R.styleable.DeviceStateBoardView_scaleColor, Color.WHITE);
        mScaleTextSize = a.getDimensionPixelSize(R.styleable.DeviceStateBoardView_scaleTextSize, spToPx(12));
        mUnitText = a.getString(R.styleable.DeviceStateBoardView_unitText);
        mUnitTextSize = a.getDimensionPixelSize(R.styleable.DeviceStateBoardView_unitTextSize, spToPx(14));
        mMinValue = a.getInteger(R.styleable.DeviceStateBoardView_minValue, 0);
        mMaxValue = a.getInteger(R.styleable.DeviceStateBoardView_maxValue, 150);
        mRibbonWidth = a.getDimensionPixelSize(R.styleable.DeviceStateBoardView_ribbonWidth, 0);
    ...
    public float[] getCoordinatePoint(int radius, float cirAngle) {
        ...
        Log.i("getCoordinatePoint","radius="+radius+",cirAngle="+cirAngle+",point[0]="+point[0]+",point[1]="+point[1]);
        return point;
    }
